...
//        d.setWorkMem(5); // B=5
//
//    	JoinOperator joinOperator = new BNLJOperator(new TestSourceOperator(), new TestSourceOperator(), "int", "int",
//    			d.beginTransaction().getTransactionContext());
//        checkIOs(0);
//
//        Iterator<Record> outputIterator = joinOperator.iterator();
//        System.out.print(outputIterator.hasNext());
//    }
