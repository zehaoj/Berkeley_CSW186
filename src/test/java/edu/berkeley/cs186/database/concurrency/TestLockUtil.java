...
public class TestLockUtil {
    ...
    public void testSIX4() {
        ...
        assertEquals(Collections.singletonList(
                         "acquire-and-release 0 database SIX [database, database/table1/1]"
                     ), lockManager.log);
    }
    ...
    public void testNotSIX() {
        ...
        LockUtil.ensureSufficientLockHeld(dbContext, LockType.S);
        assertEquals(Collections.singletonList(
                         "acquire-and-release 0 database S [database, database/table1, database/table1/1, database/table1/2]"
                     ), lockManager.log);
    }
